...
from kudzu    import __version__ as kudzu_version

ROOT_DIR = (Path(__file__).parent).parent

project   = 'Kudzu'
version   = kudzu_version
...
extlinks = {
	'issue': ('https://github.com/shrine-maiden-heavy-industries/kudzu/issues/%s', 'kudzu/%s'),
...
html_baseurl     = 'https://kudzu.shmdn.link/'
html_theme       = 'furo'
html_copy_source = False

html_theme_options = {
	'announcement': 'This documentation is a work in progress, and you can help us <a href="https://github.com/shrine-maiden-heavy-industries/kudzu/blob/main/CONTRIBUTING.md">improve it!</a>', # noqa: E501
	'light_css_variables': {
	...
	'source_repository': 'https://github.com/shrine-maiden-heavy-industries/kudzu/',
	'source_branch': 'main',
